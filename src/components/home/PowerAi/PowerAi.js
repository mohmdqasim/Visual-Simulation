...
function PowerAi() {
  ...
  return (
    <React.Fragment>
      <div className="powerAi">
        <div className='container'>
          <div className="innerSection" data-aos="fade-right"
            data-aos-duration="1000">
            <div className="container">
              <div className="title" data-aos="fade-up"
            data-aos-duration="1000">
                <h2>Building Safer Futures with VR:
                Train, Prevent, Protect</h2>
                <p>Enhance construction safety with immersive VR training. Simulate real-world scenarios, prevent accidents, and protect your team with cutting-edge technology</p>
                <div className="btns">
                  <Link to="/contactUs#contactForm" className="sheen">
                    Get Started
